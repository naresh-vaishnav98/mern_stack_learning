...
const { create, destroy, changeStatus, update, details, view } = require('../../controller/admin/testimonials.controller');
const router = express.Router();
const multer = require('multer')
const upload = multer({ dest: 'uploads/testimonials' })
...
module.exports = server => {
    ...
    server.use('/api/admin/testimonials', router);
}