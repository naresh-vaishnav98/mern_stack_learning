...
const { create, destroy, changeStatus, update, details, view } = require('../../controller/admin/subCategory.controller');
const router = express.Router();
const multer = require('multer')
const upload = multer({ dest: 'uploads/subCategory' })
...
module.exports = server => {
    ...
    server.use('/api/admin/subCategories', router);
}