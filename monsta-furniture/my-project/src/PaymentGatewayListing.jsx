...
export default function PaymentGatewayListing() {
    return (
        <>
            <div className='mt-[40px] mx-3 flex justify-between'>
                <h2 className='text-2xl'>Payment Gateway Listing</h2>
                ...
                <div className='flex justify-between'>
                    ...
                    <div className=' flex items-center rounded px-3'>
                        ...
                        <div className='flex p-1 gap-2 items-center border border-1 bg-white'>
                            ...
                            <GrDocumentText className='hover:bg-gray-200 text-2xl' />
                        ...
                        <tbody className='text-gray-500 bg-white'>
                            <tr class="bg-white border-b">
                                ...
                                <td class="px-6 py-4 border border-slate-300">
                                    <button className='w-[60px] h-[30px] border border-1 bg-[#4DC36F] text-white rounded'>Active</button>
                                </td>
                                <td class="px-6 py-4 border border-slate-300">
                                    <div className='flex'>
