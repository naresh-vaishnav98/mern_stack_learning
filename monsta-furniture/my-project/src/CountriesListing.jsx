    ...
    return (
        <>
                            ...
                            <div className='w-[600px] border border-1 rounded mx-auto fixed  inset-x-[500px] bg-white p-5'>
                                ...
                                <form action="" className='py-5 text-gray-500'>
                                    ...
                                    <div className='flex gap-2 justify-self-end mt-3'>
                                        ...
                                        <button className='flex gap-2 items-center rounded px-3 py-1 border bg-[#448cee] text-white'><FaRegSave /> Update Country</button>
                                    </div>
                            ...
                            <div className='w-[600px] border border-1 rounded mx-auto fixed z-10 inset-x-[500px] bg-white p-5'>
                                ...
                                <form action="" className='py-5 text-gray-500'>
                                    ...
                                    <div className='flex gap-2 justify-self-end mt-3'>
                                        ...
                                        <button className='flex gap-2 items-center rounded px-3 py-1 border bg-[#448cee] text-white'><FaRegSave /> Create Country</button>
                                    </div>
            ...
            <div className='mt-[40px] mx-3 flex justify-between'>
                <h2 className='text-2xl'>Countries Listing</h2>
                    ...
                    <div className=' mt-[60px] border border-1 rounded p-5 mx-5'>
                        ...
                        <div>
                            <form action="" className='flex gap-5'>
                                ...
                                <button className='flex items-center rounded bg-[#478CEE] text-white px-3 gap-2'><IoIosSearch /> Filter Countries</button>
