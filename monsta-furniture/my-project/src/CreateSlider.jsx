  ...
  return (
    <>
        <div className='mt-[40px] mx-3'>
            <h2 className='text-2xl'>Create Slider</h2>
        </div>
      ...
      <div className=' mt-[60px] border border-1 rounded p-5 mx-5 flex gap-8 text-gray-600'>
        ...
        <div className='w-[70%] text-gray-600'>
            <form action="#">
                ...
                <button className='flex items-center justify-cenetr gap-2 rounded bg-[#3e8ef7] text-white text-sm p-1 px-2 mt-3'><FaRegSave/> Create Slider</button>
            </form>
        </div>
      </div>
    </>
