        ...
        <div className='border-b border-gray-200'>
            <div className='max-w-[1320px] h-[65px] mx-auto flex justify-center items-center text-sm'>
                <ul className='uppercase flex gap-10 text-gray-600 font-semibold text-sm'>
                    ...
                    <li className='flex gap-1 items-center hover:text-[#C09578] cursor-pointer'>Living <IoIosArrowDown /></li>
                    <li className='flex gap-1 items-center hover:text-[#C09578] cursor-pointer'>Sofa <IoIosArrowDown /></li>
                    <li className='flex gap-1 items-center hover:text-[#C09578] cursor-pointer'>Pages <IoIosArrowDown /></li>
